...
export const galleryPage = defineType({
  ...
  fields: [
    ...
    defineField({
      name: "activitiesIcon",
      title: "Activities Icon (Material Icon Name)",
      type: "string",
      initialValue: "photo_camera",
      description: "Contoh: photo_camera, collections, camera_alt",
    }),
    ...
    defineField({ name: "activitiesCtaLabel", title: "Activities CTA Label", type: "string" }),
    defineField({
      name: "activitiesCtaUrl",
      title: "Activities CTA URL",
      type: "string",
